...
export default function HomePage() {
  ...
  // Giriş yoksa artık filtre/arama ekranı yok; sade bir bilgilendirme göster.
  return (
    <div className="flex min-h-screen items-center justify-center px-4 py-10">
      <div className="max-w-md rounded-2xl border border-dark-lighter bg-dark-light p-6 text-center sm:p-8">
        <h1 className="text-lg font-bold text-white sm:text-xl">Rekabetçi Denemeleri</h1>
        <p className="mt-2 text-sm text-gray-400">
          Deneme sonuçlarını görmek için lütfen önce giriş sayfasından TC kimlik numaranızı
          veya okul numaranızı girin.
        </p>
        <Link
          href="/giris"
